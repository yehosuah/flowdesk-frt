    ...
    >
      ...
      >
        ...
        <div class="modal__header">
          <h2 id="edit-employee-modal-title" class="modal__title">
            Editar Empleado
          </h2>
...
const selectedRoleLabel =
  computed(() => {
    ...
    /*
      Mientras los roles están cargando,
      mostramos el nombre que ya tiene
      el empleado.
    */
    return (
      selected?.name ??
...
onMounted(async () => {
  try {
    ...
    // Si falla la carga de roles,
    // conservamos el rol actual.
  }
});
...
@media (max-width: 390px) {
  ...
  .custom-select__options {
    /*
      Sigue teniendo exactamente
      el ancho del selector.
    */
    width: 100%;
  }
}
